...
| **doc/design/设计文档规范.md** | 设计文档规范：目录组织、文档命名规范、新增功能流程 |
| **doc/design/ROADMAP.md** | 实施路线图，按发布版本（前两位）概述各版本里程碑能力 |
| **doc/design/2026-{date}-{feature}/** | 各里程碑/功能的设计文档（product 产品 / technical 技术 / tasks 任务）与专项设计，按 `{date}-{feature}` 组织 |
